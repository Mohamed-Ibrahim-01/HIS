...
public class Medication {
    ...
    public int getWeeklyDose() {
        return WeeklyDose;
    }

    public void setWeeklyDose(int DailyDose) {
        WeeklyDose = DailyDose * 7;
    }
    ...
    public void setDoseValue(int doseValue) {
        DoseValue = doseValue;
    }

    @Override
    public String toString() {
        return "name =  " + Name + " dailydose = " + DailyDose + " Weeklydose  =" + WeeklyDose + " dosevalue = "
                + DoseValue;
