...
class PersonMH{
    ...
    private HashMap<Medication,Date> Medications;
    private ArrayList<String> GeneticDiseases;
    
    public PersonMH(){
    }
    public PersonMH(HashMap<String,Date> ChronicDiseases,HashMap<String,Date> Diseases
        ,HashMap<String,Date> Hospitalizations ,HashMap<Medication,Date> Medications,ArrayList<String> GeneticDiseases){
   ...
   public HashMap<Medication,Date> getMedications(){ return this.Medications;}
   ...
   public void setMedications(HashMap<Medication,Date> Medications){this.Medications = Medications;}
